...
export const customers = handleActions({
  ...
  [UPDATE_CUSTOMER]: (state, action) => {
    ...
    const { id } = customerPayload; // Get id from when was updated.
    const customers = state; // All customer before update.
    const initialValue = []; // Initial value before call to reducer.
